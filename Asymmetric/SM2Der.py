...
class SM2AsymmetricDer:
    ...
    def encrypt(self, plain_text: str, public_key: str, asn1_der: bool = False) -> str:
        """
            ...
            :params asn1_der True: 输出C1C3C2Der格式Base64编码加密值; False: 输出C1C3C2Raw格式Hex编码加密值
        ...
        return encrypted_data if asn1_der == False else SM2AsymmetricEncryptedDataConvert.C1C3C2Raw_to_C1C3C2Der(encrypted_data)
    ...
    def decrypt(self, private_key: str, encrypted_data: str, asn1_der = bool) -> str:
        """
            ...
            :params encrypted_data utf-8字符集 支持: C1C3C2Raw格式Hex编码加密值/C1C3C2Der格式Base64编码加密值
            :params asn1_der True: 输入C1C3C2Der格式Base64编码加密值; False: 输入C1C3C2Raw格式Hex编码加密值
            :returns: String类型-原文 Base64编码
        """
        private_key: str = SM2PrivateKeyProcess(private_key).private_key_der.get_hex_raw() # 处理SM2私钥
        # 解密
        encrypted_data  = encrypted_data if asn1_der == False else SM2AsymmetricEncryptedDataConvert.C1C3C2Der_to_C1C3C2Raw(encrypted_data)
...
class SM2AsymmetricEncryptedDataConvert:
    ...
    def C1C2C3Der_to_C1C3C2Der(encrypted_data: str) -> str:
        """
        C1C2C3Der格式Base64编码转换为C1C3C2Der格式Base64编码
        :params encrypted_data String类型 C1C2C3Der格式Base64编码加密值
        :return: String类型 输出C1C3C2Der格式Base64编码加密值
        """
    ...
    def C1C3C2Der_to_C1C2C3Der(encrypted_data: str) -> str:
        """
        C1C3C2Der格式Base64编码转换为C1C2C3Der格式Base64编码
        :params encrypted_data String类型 C1C3C2Der格式Base64编码加密值
        :return: String类型 输出C1C2C3Der格式Base64编码加密值
        """
    ...
    def C1C2C3Der_to_C1C2C3Raw(encrypted_data: str) -> str:
        """
        C1C2C3Der格式Base64编码转换为C1C2C3Raw格式Hex编码
        :params encrypted_data String类型 C1C2C3Der格式Base64编码加密值
        :return: String类型 输出C1C2C3Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C2C3Der_split_C1C2C3(encrypted_data)
        return "04" + C1 + C2 + C3
    ...
    def C1C3C2Der_to_C1C2C3Raw(encrypted_data: str) -> str:
        """
        C1C3C2Der格式Base64编码转换为C1C2C3Raw格式Hex编码
        :params encrypted_data String类型 C1C3C2Der格式Base64编码加密值
        :return: String类型 输出C1C2C3Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C3C2Der_split_C1C2C3(encrypted_data)
    ...
    def C1C2C3Der_to_C1C3C2Raw(encrypted_data: str) -> str:
        """
        C1C2C3Der格式Base64编码转换为C1C3C2Raw格式Hex编码
        :params encrypted_data String类型 C1C2C3Der格式Base64编码加密值
        :return: String类型 输出C1C3C2Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C2C3Der_split_C1C2C3(encrypted_data)
        return "04" + C1 + C3 + C2
    ...
    def C1C3C2Der_to_C1C3C2Raw(encrypted_data: str) -> str:
        """
        C1C3C2Der格式Base64编码转换为C1C3C2Raw格式Hex编码
        :params encrypted_data String类型 C1C3C2Der格式Base64编码加密值
        :return: String类型 输出C1C3C2Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C3C2Der_split_C1C2C3(encrypted_data)
    ...
    def C1C2C3Raw_to_C1C3C2Raw(encrypted_data: str) -> str:
        """
        C1C2C3Raw格式Hex编码转换为C1C3C2Raw格式Hex编码
        :params encrypted_data String类型 C1C2C3Raw格式Hex编码加密值
        :return: String类型 输出C1C3C2Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C2C3Raw_split_C1C2C3(encrypted_data)
        return "04" + C1 + C3 + C2
    
    @staticmethod
    def C1C3C2Raw_to_C1C2C3Raw(encrypted_data: str) -> str:
        """
        C1C3C2Raw格式Hex编码加密值转换为C1C2C3Raw格式Hex编码加密值
        :params encrypted_data String类型 C1C3C2Raw格式Hex编码加密值
        :return: String类型 输出C1C2C3Raw格式Hex编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C3C2Raw_split_C1C2C3(encrypted_data)
        return "04" + C1 + C2 + C3
    ...
    def C1C3C2Raw_to_C1C3C2Der(encrypted_data: str) -> str:
        """
        C1C3C2Raw格式Hex编码加密值转换为C1C3C2Der格式Base64编码加密值
        :params encrypted_data String类型 C1C3C2Raw格式Hex编码加密值
        :return: String类型 输出C1C3C2Der格式Base64编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C3C2Raw_split_C1C2C3(encrypted_data)
    ...
    def C1C2C3Raw_to_C1C3C2Der(encrypted_data: str) -> str:
        """
        C1C2C3Raw格式Hex编码加密值转换为C1C3C2Der格式Base64编码加密值
        :params encrypted_data String类型 C1C2C3Raw格式Hex编码加密值
        :return: String类型 输出C1C3C2Der格式Base64编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C2C3Raw_split_C1C2C3(encrypted_data)
    ...
    def C1C3C2Raw_to_C1C2C3Der(encrypted_data: str) -> str:
        """
        C1C3C2Raw格式Hex编码加密值转换为C1C2C3Der格式Base64编码加密值
        :params encrypted_data String类型 C1C3C2Raw格式Hex编码加密值
        :return: String类型 输出C1C2C3Der格式Base64编码加密值
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C3C2Raw_split_C1C2C3(encrypted_data)
    ...
    def C1C2C3Raw_to_C1C2C3Der(encrypted_data: str) -> str:
        """
        C1C2C3Raw格式Hex编码加密值转换为C1C3C2Der格式Base64编码
        :params encrypted_data String类型 C1C2C3Raw格式Hex编码加密值
        :return: String类型 输出C1C3C2Der格式Base64编码
        """
        C1, C2, C3 = SM2AsymmetricEncryptedDataConvert._C1C2C3Raw_split_C1C2C3(encrypted_data)
        return SM2AsymmetricEncryptedDataConvert._C1C2C3_to_C1C2C3Der(C1, C2, C3)
    ...
    def _C1C3C2Der_split_C1C2C3(encrypted_data: str) -> Tuple[str]:
        """
        C1C3C2Der格式Base64编码加密值转换为C1、C2、C3
        :params encrypted_data String类型 C1C3C2Der格式Base64编码加密值
        :return: tuple类型 输出C1, C2, C3 (C1为64长度不带"04"标识)
        """
    ...
    def _C1C2C3Der_split_C1C2C3(encrypted_data: str) -> Tuple[str]:
        """
        C1C2C3Der格式Base64编码加密值转换为C1、C2、C3
        :params encrypted_data String类型 C1C2C3Der格式Base64编码加密值
        :return: tuple类型 输出C1, C2, C3 (C1为64位不带"04"标识)
        """
        encrypted_data_der_list: List[DerObjectIBase] = DerObjectsSplit(StringConvert.base64_convert_hex(encrypted_data)).der_objects_list
        C1 = "".join([i.get_hex_raw() for i in encrypted_data_der_list if isinstance(i, ASN1DerToRawINTEGER)])
    ...
    def _C1C2C3_to_C1C3C2Der(C1: str, C2: str, C3: str) -> str:
        """
        将C1 C2 C3 转换为C1C3C2Der格式Base64编码加密值
        :params C1 String类型
        :params C2 String类型
        :params C3 String类型
        :return: String类型 输出C1C3C2Der格式Base64编码加密值
    ...
    def _C1C2C3_to_C1C2C3Der(C1: str, C2: str, C3: str) -> str:
        """
        将C1 C2 C3 转换为C1C2C3Der格式Base64编码加密值
        :params C1 String类型 64位不带"04"标识
        :params C2 String类型
        :params C3 String类型
        :return: String类型 输出C1C2C3Der格式Base64编码加密值
        """
    ...
    @staticmethod
    def _C1C2C3Raw_split_C1C2C3(encrypted_data: str) -> Tuple[str]:
        """
        将包含04标识符的C1C2C3Raw格式Hex编码加密值切分出C1 C2 C3
    ...
    @staticmethod
    def _C1C3C2Raw_split_C1C2C3(encrypted_data: str) -> Tuple[str]:
        """
        将包含04标识符的C1C3C2Raw格式Hex编码加密值切分出C1 C2 C3
        :params encrypted_data String类型 加密值
        :return: tuple类型 输出C1, C2, C3 (C1为64位不带"04"标识)
        """
        encrypted_data = encrypted_data[2:] if encrypted_data[:2] == "04" else encrypted_data # 去掉04标识位
