...
class TestDerIBase(unittest.TestCase):
    ...
    def test_129_data(self):
        ...
        # 测试长度大于129字节的数据
        assert_129_result = {
            "raw_value": "",
        ...
        # 开始测试
        test: BitString = RawToASN1DerObjectFactory.create_der_object(assert_129_result["raw_value"], assert_129_result["tag"])
        ...
        self.assertEqual(test.get_hex_der(), assert_129_result["result"])
    ...
    def test_Sequence_data(self):
        ...
        sub_der_1: dict = {
            "raw_value": "06072A8648CE3D020106082A811CCF5501822D",
            "tag": ASN1DerObjectTagsEnum.Sequence.value,
            "length": "13",
            "value": "06072A8648CE3D020106082A811CCF5501822D",
            "result": "301306072A8648CE3D020106082A811CCF5501822D"
        }
        sub_der_1_1: dict = {
            "raw_value": "2A8648CE3D0201",
        ...
        sub_der_1_2: dict = {
            "raw_value": "2A811CCF5501822D",
            "tag": ASN1DerObjectTagsEnum.Oid.value,
            "length": "08",
            "value": "2A811CCF5501822D",
            "result": "06082A811CCF5501822D"
        }
        sub_der_2: dict = {
            "raw_value": "046A826E79032BA6144FA1EB22F4F2BA3D2B77EBDC54789C1EF15B64FBCFE7A259E771DDD2FE6DDB377B1A9820B394F58AFA2BF02226EC5DAEFACC14B2A22D4E11",
            "tag": ASN1DerObjectTagsEnum.BitString.value,
            "length": "42",
            ...
            "result": "034200046A826E79032BA6144FA1EB22F4F2BA3D2B77EBDC54789C1EF15B64FBCFE7A259E771DDD2FE6DDB377B1A9820B394F58AFA2BF02226EC5DAEFACC14B2A22D4E11"
        }
        # 开始测试
        ## sub_der_1 拼装过程
        ### 实例化 sub_der_1_1
        sub_der_1_1_instance: Oid = RawToASN1DerObjectFactory.create_der_object(sub_der_1_1["raw_value"], sub_der_1_1["tag"])
        ...
        self.assertEqual(sub_der_1_1_instance.get_hex_der(), sub_der_1_1["result"])
        ### 实例化 sub_der_1_2
        sub_der_1_2_instance: Oid = RawToASN1DerObjectFactory.create_der_object(sub_der_1_2["raw_value"], sub_der_1_2["tag"])
        ...
        self.assertEqual(sub_der_1_2_instance.get_hex_der(), sub_der_1_2["result"])
        #### 拼装 sub_der_1
        ...
        self.assertEqual(sub_der_1_instance.get_hex_der(), sub_der_1["result"])
        ## sub_der_2 拼装过程
        sub_der_2_instance: BitString = RawToASN1DerObjectFactory.create_der_object(sub_der_2["raw_value"], sub_der_2["tag"])
        ...
        self.assertEqual(sub_der_2_instance.get_hex_der(), sub_der_2["result"])
        ## der_all_in_one 拼装
        ...
        self.assertEqual(der_all_in_one_instance.get_hex_der(), der_all_in_one["result"])
