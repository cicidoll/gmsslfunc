...
class TestDerIBase(unittest.TestCase):
    ...
    def test_129_data(self):
        ...
        self.assertEqual(test.get_hex_raw(), assert_129_result["hex_raw_value"])
    ...
    def test_bit_string(self):
        ...
        self.assertEqual(test.get_hex_raw(), assert_bitstring_value_result["hex_raw_value"])
